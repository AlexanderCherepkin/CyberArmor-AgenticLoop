...
| Safety policy violation in logged event | Escalate to `safety-control/safety_assessor.md` and `safety-control/mutual_check/audit_logger.md`; block further execution until reviewed |
