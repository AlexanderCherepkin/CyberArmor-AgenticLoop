...
| Safety-control flags the requested action | Require explicit clearance from `safety-control/threat_detector.md` and `safety-control/permission_checker.md` before presenting approval |
